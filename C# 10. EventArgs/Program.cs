...
ExamEventArgs examEventArgs = new ExamEventArgs {Task= "Napisat kalkulyator" };
teacher.Exam(examEventArgs);
teacher1.Exam(new ExamEventArgs { Task= "Sdelat sayt"});
...
class Student
{
    ...
    {
        Console.WriteLine($"{(sender as Teacher)?.FirstName} otpravil Task");
        if (Age < 18)
        {
